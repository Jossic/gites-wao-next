        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              console.log(data);
              setLoading(true);
              Object(_actions_userActions__WEBPACK_IMPORTED_MODULE_9__["updateUser"])(data, token).then(function (result) {
                ...
                if (result.error) {
                  ...
                  setTimeout(function () {
                    next_router__WEBPACK_IMPORTED_MODULE_4___default.a.push("/admin/users/".concat(router.query.id), null, {
                      shallow: true
                    });
                  }, 3000);
                }
...
var UserId = function UserId(_ref2) {
  ...
  }, "Gestion de l'utilisateur ", user.nom, __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_11__["default"], {
    style: {
      color: 'red'
    },
    __self: _this,
