...
var AdminHeader = function AdminHeader(_ref) {
  ...
  var recupUser = function recupUser() {
    Object(_actions_userActions__WEBPACK_IMPORTED_MODULE_13__["getUserById"])(Object(_actions_authActions__WEBPACK_IMPORTED_MODULE_7__["isAuth"])()._id).then(function (data) {
      if (data.error) {
        console.log(data.error);
      } else {
        setnewReservation(data);
