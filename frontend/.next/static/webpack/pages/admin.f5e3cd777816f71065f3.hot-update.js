...
var AdminHeader = function AdminHeader(_ref) {
  ...
  var recupUser = function recupUser() {
    if (_actions_authActions__WEBPACK_IMPORTED_MODULE_7__["isAuth"]) {
      console.log(_actions_authActions__WEBPACK_IMPORTED_MODULE_7__["isAuth"]);
      Object(_actions_userActions__WEBPACK_IMPORTED_MODULE_13__["getUserById"])().then(function (data) {
        if (data.error) {
          console.log(data.error);
        } else {
          setnewReservation(data);
